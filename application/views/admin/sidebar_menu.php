<div class="f8-sec-admin-menus">
  <div class="list-group f8-menu">
    ...
    <a class="list-group-item" href="<?php echo base_url('auth/create_user');?>">Add User</a>

    <a class="list-group-item" href="<?php echo base_url('admin/roles/list');?>">Show User Groups</a>
