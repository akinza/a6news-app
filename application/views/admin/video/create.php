        ...
        <div class="f8-sec-inner-block">
          ...
          <?php echo form_open(base_url("video/create")); ?>
            ...
            <div class="form-group">
              ...
              <div class="well well-sm"><code>https://www.youtube.com/watch?v=</code><?php echo form_input($video_link);?></div>
              <p class="help">Please enter youtube video id eg. &mdash;<span class="text-muted">https://www.youtube.com/watch?v=<b style="border:1px solid orange; padding:5px;">AhWMOkrzKzs</b></span>.</p>
            </div>
            <div class="form-group">
              <div class="">
