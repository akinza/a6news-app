...
<link id="favicon" rel="shortcut icon" href="<?php echo base_url(IMAGES. '/icon_32.png'); ?>" type="image/png" />
<link rel="stylesheet" href="<?php echo base_url(COMPONENTS."/bootstrap/dist/css/bootstrap.css"); ?>" >
<!-- <link rel="stylesheet" href="<?php echo base_url(COMPONENTS."/bootstrap-drawer/dist/css/bootstrap-drawer.min.css"); ?>" > -->
