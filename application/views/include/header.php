        ...
        <ul class="drawer-menu">
          ...
          <li class="drawer-dropdown">
            <a class="drawer-menu-item"
              ...
              role="button"
              aria-expanded="true">More <span class="drawer-caret"></span>
            </a>
            <ul class="drawer-dropdown-menu">
              <li><a class="drawer-dropdown-menu-item"  href="<?php echo base_url("/p/world"); ?>">World</a></li>
              <li><a class="drawer-dropdown-menu-item"  href="<?php echo base_url("/p/culture"); ?>">Culture</a></li>
              <li><a class="drawer-dropdown-menu-item"  href="<?php echo base_url("/p/movies"); ?>">Movies</a></li>
              <li><a class="drawer-dropdown-menu-item"  href="<?php echo base_url("/p/music"); ?>">Music</a></li>
              <li><a class="drawer-dropdown-menu-item"  href="<?php echo base_url("/p/food"); ?>">Food</a></li>
              <li><a class="drawer-dropdown-menu-item"  href="<?php echo base_url("/p/tv"); ?>">TV</a></li>
            </ul>
          </li>
        </ul>
        <ul class="drawer-menu pull-right">
          <?php
            if($this->ion_auth->logged_in()){
              ?>
                ...
                <li class="drawer-dropdown">
                  <a class="drawer-menu-item" data-target="#" href="#" data-toggle="dropdown" role="button" aria-expanded="false">
                    <?php echo $this->ion_auth->user()->row()->first_name." (".$this->ion_auth->user()->row()->email.")" ;?> <span class="drawer-caret"></span>
                  </a>
                  <ul class="drawer-dropdown-menu">
              ...
              ?>
                <li><a class="drawer-menu-item" href="<?php echo base_url("auth/login"); ?>">Sign in</a></li>
              <?php
            }
          ?>
          <!-- <li><a class="drawer-menu-item" href="<?php echo base_url("admin"); ?>"></a></li> -->
        </ul>
      </nav>
    </div>
  </header>
